...
class LINK_URDF:
    ...
    def __init__(self,name,pos,size,shape="box",rpy=[0,0,0], materialName="Cyan", color=[0,1.0,1.0,1.0]):
        ...
        self.visual    = VISUAL_URDF(self.origin, self.geometry, materialName=materialName, color=color)
